...
export default class MovieNewContainer extends BaseComponent {
    ...
    componentDidMount() {
        Http.getDouBan({url: URLS.newMovies, param: {client: '', udid: ''}}, res => {
            this.setState({
    ...
    renderHeader = () => {
        return (
            <ImageBackground style={styles.head}
                ...
                <View>
                    <Text style={BaseStyle.s18cFFFFFF}>一周热门电影榜</Text>
                    <Text style={[BaseStyle.s12cABABAE, styles.headText]}>每周五更新</Text>
                </View>
        ...
        return (
            <SafeAreaView style={BaseStyle.container}>
                <FlatList
                    ...
                    renderItem={({item, index}) => <NewItem number={index + 1}
